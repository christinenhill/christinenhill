	...
	<body id="top">
		...
		<!-- Header -->
			<header id="header">
				...
				<h1>Hi, I'm <strong>Christine.</strong><br />
				Marketing/Design</h1>
			</header>
					...
					<section id="three">
						...
						<div class="row">
							<div class="8u 12u$(small)">
								...
								<ul class="actions">
									<li><input type="submit" value="Send Message" form="email_form" /></li>
								</ul>
							</div>
							<div class="4u$ 12u$(small)">
								<ul class="labeled-icons">
									...
									<li>
										...
										<a href="mailto:christine.n.hill@gmail.com">christine.n.hill@gmail.com</a>
									</li>
								</ul>
							</div>
						</div>
